...
const HeroSection = () => {
    return(
        <section className="bg-background-secondary md:rounded-4xl flex flex-col gap-10 items-center justify-center md:mx-18 my-3 py-10 px-5 md:px-24 border-[0.2px] border-gray-200">
            <h1 className="text-center text-4xl md:text-6xl font-bold text-shadow-md">Tenha <WordRotate className="text-primary-green " words={["clareza", "controle", "previsibilidade"]} />sobre seus números</h1>
